        ...
        <div class="col-md-8">
            <div class="card mb-5">
                ...
                <div class="card-body">
                    ...
                    {{ __('Update your workspace here!') }}
                </div>
            </div>

            <div class="float-start">
                <h4 class="pb-3">{{ __('Update Workspaces - ') }}{{ $workspace->title }}</h4>
            </div>
            <div class="float-end">
            ...
            <div class="card card-body bg-light p-4">
                <form action="{{ route('workspace.update', $workspace->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control mb-2" id="title" name="title" value="{{ $workspace->title }}">
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control" id="description" name="description" rows="5">{{ $workspace->description }}</textarea>
                    </div>
                    <br>
